...
Phase 2 does not live-tick prices here — `basePrice` is static between Phase 3's daily refresh. On freshly-bought packs, both columns will read identically. That is honest and called out in the Q&A.
